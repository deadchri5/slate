...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rack>.freeze, [">= 1.4.5".freeze, "< 3".freeze])
  s.add_runtime_dependency(%q<tilt>.freeze, ["~> 2.0.9".freeze])
  ...
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 6.1".freeze, "< 7.1".freeze])
  ...
  s.add_runtime_dependency(%q<i18n>.freeze, ["~> 1.6.0".freeze])
  s.add_runtime_dependency(%q<fastimage>.freeze, ["~> 2.0".freeze])
  s.add_runtime_dependency(%q<sassc>.freeze, ["~> 2.0".freeze])
  s.add_runtime_dependency(%q<uglifier>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<execjs>.freeze, ["~> 2.0".freeze])
  s.add_runtime_dependency(%q<contracts>.freeze, ["~> 0.13".freeze])
  s.add_runtime_dependency(%q<hashie>.freeze, ["~> 3.4".freeze])
  s.add_runtime_dependency(%q<hamster>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<backports>.freeze, ["~> 3.6".freeze])
end
