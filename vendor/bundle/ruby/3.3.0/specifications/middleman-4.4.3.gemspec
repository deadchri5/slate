...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<middleman-core>.freeze, ["= 4.4.3".freeze])
  s.add_runtime_dependency(%q<middleman-cli>.freeze, ["= 4.4.3".freeze])
  s.add_runtime_dependency(%q<haml>.freeze, [">= 4.0.5".freeze, "< 6.0".freeze])
